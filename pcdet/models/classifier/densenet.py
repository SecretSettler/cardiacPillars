...
class DenseNet(nn.Module):
    ...
    def __init__(
        ...
        # self.fc2 = nn.Linear(1679, num_features)
        # BN and Dropout
        # self.bn = nn.BatchNorm1d(num_features)
        # self.bn1 = nn.BatchNorm1d(1679)
    ...
    def forward(self, data_dict):
        if self.model_cfg.BACKBONE_2D is None:
        ...
        # out = self.fc1(out)
        # out = torch.cat([out, thickness, volume], dim=1)
        # out = self.bn1(out)
